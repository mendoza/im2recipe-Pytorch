...
def get_parser():
    ...
    parser.add_argument('--test_image_path', default='cheese_cake.jpg', type=str)    
    ...
    parser.add_argument('--report_path', default = '../data/', type=str)
    parser.add_argument('--data_aug', default='old', type=str)
